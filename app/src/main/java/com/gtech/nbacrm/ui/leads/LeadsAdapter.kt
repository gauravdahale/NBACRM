...
class LeadsAdapter(val mContext: LeadFragment, val mList: ArrayList<ReadLeadModel>) :
    RecyclerView.Adapter<LeadsAdapter.ViewHolder>(), Filterable {
        ...
        holder.setItemOnclickListener(object : ItemClickListener {
            override fun onItemClick(i: Int) {
                ...
                mContext.mNavController.navigate(
                    R.id.action_navigation_leads_to_updateLeadFragment,
                    bundle
                )
            }
